    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        <motion.div
          ...
          animate={{ scale: 1 }}
        >
          <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-heartshare flex items-center justify-center">
            <svg
          ...
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-pink-2 to-sky-2 bg-clip-text text-transparent">
            HeartShare
          </h1>
          <p className="text-gray-700">Enter your details to start a video call</p>
        </motion.div>
