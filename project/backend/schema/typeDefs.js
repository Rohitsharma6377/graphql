export const typeDefs = `#graphql
  ...
  type Mutation {
    ...
    # Video State
    updateVideoState(roomId: ID!, isMuted: Boolean, isVideoOff: Boolean, isScreenSharing: Boolean, isSpeaking: Boolean): VideoState!
  }

  type Subscription {
    messageSent(roomId: ID!): Message!
    userJoined(roomId: ID!): ParticipantEvent!
    userLeft(roomId: ID!): ParticipantEvent!
