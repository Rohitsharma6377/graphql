...
export const UPDATE_VIDEO_STATE = gql`
  mutation UpdateVideoState($roomId: ID!, $isMuted: Boolean, $isVideoOff: Boolean, $isScreenSharing: Boolean, $isSpeaking: Boolean) {
    updateVideoState(roomId: $roomId, isMuted: $isMuted, isVideoOff: $isVideoOff, isScreenSharing: $isScreenSharing, isSpeaking: $isSpeaking) {
      userId
      roomId
      isMuted
      isVideoOff
...
export const MESSAGE_SENT_SUBSCRIPTION = MESSAGE_SENT
...
// Alias for compatibility
export const USER_JOINED_SUBSCRIPTION = USER_JOINED
...
// Alias for compatibility
export const USER_LEFT_SUBSCRIPTION = USER_LEFT
...
export const VIDEO_STATE_CHANGED = gql`
  subscription VideoStateChanged($roomId: ID!) {
    videoStateChanged(roomId: $roomId) {
      userId
      roomId
      isMuted
      isVideoOff
