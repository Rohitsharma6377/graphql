...
import { Video, Clock, Users, Search, Copy, Check, Link2 } from 'lucide-react'
                        ...
                        <CardContent className="p-6">
                          <div className="flex flex-col md:flex-row md:items-center gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                              {status === 'live' && (
                                <Button onClick={() => router.push(`/meeting/${room.id}`)}>Join Now</Button>
                              )}
                              {status !== 'live' && (
                                <Button variant="secondary" onClick={() => router.push(`/meeting/${room.id}`)}>Start</Button>
                              )}
                              <Button
                                variant="outline"
                                size="sm"
